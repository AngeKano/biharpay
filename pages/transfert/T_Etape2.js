...
const T_Etape2 =({ navigation: { navigate } }) => {
  ...
  const handleTransfer=()=>{
    axios.post(`http://192.168.1.102:8083/transactions/transfer?senderNumeroPhone=${numeroPhones}&receiverNumeroPhone=${receiverNumeroPhone}&amount=${amount}`)
  ...
  return (
    <View>
      ...
      <View style={{marginHorizontal:20,marginTop:20}}> 
        ...
        <TextInput style={{borderWidth:1,borderColor:"#04FFB4",height:60,borderRadius:10}} placeholder='Minimum 1000 FCFA'
